...
(function (exports, $) {
  ...
  Search.prototype.find = function (query, firstElem) {
    ...
    if (firstElem) {
      ...
      if (
        ...
        ["sortpokemon", "sortmove"].includes(this.resultSet[1][0])
      ) {
  ...
  Search.prototype.getFilterText = function (q) {
    ...
    for (var i = 0; i < this.filters.length; i++) {
      ...
      buf +=
        ...
        BattleLog.escapeHTML(this.filters[i].join(":")) +
        '">' +
        text +
  ...
  Search.prototype.updateScroll = function (forceAdd) {
    ...
    while (i < finalIndex) {
      ...
      if ((label = this.engine.filterLabel(row[0]))) {
        errorMessage =
          '<span class="col filtercol"><em>' + label + "</em></span>";
      } else if ((label = this.engine.illegalLabel(row[1]))) {
        errorMessage =
          '<span class="col illegalcol"><em>' + label + "</em></span>";
      }
  ...
  Search.prototype.renderRow = function (
    id,
    type,
    matchStart,
    matchLength,
    ...
    switch (type) {
      ...
      case "article":
        var articleTitle =
          (window.BattleArticleTitles && BattleArticleTitles[id]) ||
          id[0].toUpperCase() + id.substr(1);
        var article = { name: articleTitle, id: id };
        return this.renderArticleRow(
          article,
          matchStart,
          matchLength,
          errorMessage,
  ...
  Search.prototype.renderPokemonSortRow = function () {
    ...
    buf +=
      '<button class="sortcol statsortcol' +
      (this.sortCol === "hp" ? " cur" : "") +
      '" data-sort="hp">HP</button>';
    buf +=
      '<button class="sortcol statsortcol' +
      (this.sortCol === "atk" ? " cur" : "") +
      '" data-sort="atk">Atk</button>';
    buf +=
      '<button class="sortcol statsortcol' +
      (this.sortCol === "def" ? " cur" : "") +
      '" data-sort="def">Def</button>';
    if (this.engine.dex.gen >= 2) {
      buf +=
        '<button class="sortcol statsortcol' +
        (this.sortCol === "spa" ? " cur" : "") +
        '" data-sort="spa">SpA</button>';
      buf +=
        '<button class="sortcol statsortcol' +
        (this.sortCol === "spd" ? " cur" : "") +
        '" data-sort="spd">SpD</button>';
    } else {
      buf +=
        '<button class="sortcol statsortcol' +
        (this.sortCol === "spa" ? " cur" : "") +
        '" data-sort="spa">Spc</button>';
    }
    buf +=
      '<button class="sortcol statsortcol' +
      (this.sortCol === "spe" ? " cur" : "") +
      '" data-sort="spe">Spe</button>';
    buf +=
      '<button class="sortcol statsortcol' +
      (this.sortCol === "bst" ? " cur" : "") +
      '" data-sort="bst">BST</button>';
    buf += "</div></li>";
    return buf;
  };
  Search.prototype.renderMoveSortRow = function () {
    ...
    buf +=
      '<button class="sortcol ppsortcol' +
      (this.sortCol === "pp" ? " cur" : "") +
      '" data-sort="pp">PP</button>';
    buf += "</div></li>";
    return buf;
  };
  Search.prototype.renderPokemonRow = function (
    pokemon,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (Search.urlRoot)
      attrs +=
        ' href="' + Search.urlRoot + "pokemon/" + id + '" data-target="push"';
    var buf =
      '<li class="result"><a' +
      attrs +
      ' data-entry="pokemon|' +
  ...
  Search.prototype.renderTaggedPokemonRowInner = function (
    pokemon,
    tag,
    errorMessage,
  ) {
    ...
    if (tagStart)
      name =
        name.substr(0, tagStart) +
        "<small>" +
        pokemon.name.substr(tagStart) +
        "</small>";
  ...
  Search.prototype.renderItemRow = function (
    item,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (Search.urlRoot)
      attrs +=
        ' href="' + Search.urlRoot + "items/" + id + '" data-target="push"';
    var buf =
      '<li class="result"><a' +
      attrs +
      ' data-entry="item|' +
      BattleLog.escapeHTML(item.name) +
      '">';
    ...
    // desc
    buf +=
      '<span class="col itemdesccol">' +
      BattleLog.escapeHTML(item.shortDesc) +
      "</span> ";
  ...
  Search.prototype.renderAbilityRow = function (
    ability,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (Search.urlRoot)
      attrs +=
        ' href="' + Search.urlRoot + "abilities/" + id + '" data-target="push"';
    var buf =
      '<li class="result"><a' +
      attrs +
      ' data-entry="ability|' +
      BattleLog.escapeHTML(ability.name) +
      '">';
    ...
    buf +=
      '<span class="col abilitydesccol">' +
      BattleLog.escapeHTML(ability.shortDesc) +
      "</span> ";
  ...
  Search.prototype.renderLocationRow = function (
    location,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (tagStart) {
      if (matchLength && matchStart + matchLength > tagStart) {
        ...
        name +=
          "<small>" +
          location.name.substr(tagStart, matchStart - tagStart) +
          "<b>" +
          location.name.substr(matchStart, matchLength) +
          "</b>" +
          location.name.substr(matchStart + matchLength) +
          "</small>";
      } else {
  ...
  Search.prototype.renderMoveRow = function (
    move,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (Search.urlRoot)
      attrs +=
        ' href="' + Search.urlRoot + "moves/" + id + '" data-target="push"';
    var buf =
      '<li class="result"><a' +
      attrs +
      ' data-entry="move|' +
      BattleLog.escapeHTML(move.name) +
      '">';
    ...
    buf +=
      ...
      BattleLog.escapeHTML(move.shortDesc) +
      "</span> ";
  ...
  Search.prototype.renderTypeRow = function (
    type,
    matchStart,
    matchLength,
    errorMessage,
    ...
    var buf =
      ...
      attrs +
      ' data-entry="type|' +
      BattleLog.escapeHTML(type.name) +
      '">';
  ...
  Search.prototype.renderCategoryRow = function (
    category,
    matchStart,
    matchLength,
    errorMessage,
    ...
    var buf =
      ...
      attrs +
      ' data-entry="category|' +
      BattleLog.escapeHTML(category.name) +
      '">';
    ...
    buf +=
      ...
      Dex.getCategoryIcon(category.name) +
      "</span> ";
  ...
  Search.prototype.renderArticleRow = function (
    article,
    matchStart,
    matchLength,
    errorMessage,
    ...
    if (isSearchType)
      attrs = ' href="' + article.id + '/" data-target="replace"';
    var buf =
      '<li class="result"><a' +
      attrs +
      ' data-entry="article|' +
      BattleLog.escapeHTML(article.name) +
      '">';
  ...
  Search.prototype.renderEggGroupRow = function (
    egggroup,
    matchStart,
    matchLength,
    errorMessage,
    ...
    var buf =
      ...
      attrs +
      ' data-entry="egggroup|' +
      BattleLog.escapeHTML(egggroup.name) +
      '">';
  ...
  Search.prototype.renderTierRow = function (
    tier,
    matchStart,
    matchLength,
    errorMessage,
    ...
    var buf =
      ...
      attrs +
      ' data-entry="tier|' +
      BattleLog.escapeHTML(tier.name) +
      '">';
  ...
  Search.renderTaggedPokemonRowInner =
    Search.prototype.renderTaggedPokemonRowInner;
  Search.renderTaggedLocationRowInner =
    Search.prototype.renderTaggedLocationRowInner;
