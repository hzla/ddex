...
var DexSearch = /** @class */ (function () {
  ...
  DexSearch.prototype.getTypedSearch = function (
    searchType,
    format,
    speciesOrSet,
  ) {
    ...
    switch (searchType) {
      ...
      case "location":
        return new BattleLocationSearch("location", format, speciesOrSet);
    }
    return null;
  };
  DexSearch.prototype.find = function (query) {
    ...
    if (!query) {
      this.results =
        ((_a = this.typedSearch) === null || _a === void 0
          ? void 0
          : _a.getResults(this.filters, this.sortCol, this.reverseSort)) || [];
    } else {
  ...
  DexSearch.prototype.addFilter = function (entry) {
    ...
    if (this.typedSearch.searchType === "pokemon") {
      ...
      if (type === this.sortCol) this.sortCol = null;
      if (!["pokemon"].includes(type)) return false;
      if (type === "pokemon") entry[1] = toID(entry[1]);
      if (!this.filters) this.filters = [];
      this.filters.push(entry);
      this.results = null;
  ...
  DexSearch.prototype.illegalLabel = function (id) {
    ...
    return (
      ((_b =
        (_a = this.typedSearch) === null || _a === void 0
          ? void 0
          : _a.illegalReasons) === null || _b === void 0
        ? void 0
        : _b[id]) || null
    );
  };
  ...
  DexSearch.prototype.textSearch = function (query) {
    ...
    var illegal =
      (_b = this.typedSearch) === null || _b === void 0
        ? void 0
        : _b.illegalReasons;
...
var BattleTypedSearch = /** @class */ (function () {
  function BattleTypedSearch(searchType, format, speciesOrSet) {
    ...
    if (
      (format.endsWith("lc") || format.startsWith("lc")) &&
      format !== "caplc" &&
      !this.formatType
    ) {
      this.formatType = "lc";
  ...
  BattleTypedSearch.prototype.getResults = function (
    filters,
    sortCol,
    reverseSort,
  ) {
  ...
  BattleTypedSearch.prototype.firstLearnsetid = function (speciesid) {
    ...
    if (
      (_a = this.formatType) === null || _a === void 0
        ? void 0
        : _a.startsWith("bdsp")
    )
  ...
  BattleTypedSearch.prototype.nextLearnsetid = function (
    learnsetid,
    speciesid,
  ) {
    if (
  ...
  BattleTypedSearch.prototype.isHere = function (speciesid, location) {
    if (typeof location.landslot1 !== "undefined") {
      if (location.landslot1 === speciesid) return true;
      if (location.landslot2 === speciesid) return true;
      if (location.landslot3 === speciesid) return true;
      if (location.landslot4 === speciesid) return true;
      if (location.landslot5 === speciesid) return true;
      if (location.landslot6 === speciesid) return true;
      if (location.landslot7 === speciesid) return true;
      if (location.landslot8 === speciesid) return true;
      if (location.landslot9 === speciesid) return true;
      if (location.landslot10 === speciesid) return true;
      if (location.landslot11 === speciesid) return true;
      if (location.landslot12 === speciesid) return true;
    }
    if (typeof location.fishslot1 !== "undefined") {
      if (location.fishslot1 === speciesid) return true;
      if (location.fishslot2 === speciesid) return true;
      if (location.fishslot3 === speciesid) return true;
      if (location.fishslot4 === speciesid) return true;
      if (location.fishslot5 === speciesid) return true;
      if (location.fishslot6 === speciesid) return true;
      if (location.fishslot7 === speciesid) return true;
      if (location.fishslot8 === speciesid) return true;
      if (location.fishslot9 === speciesid) return true;
      if (location.fishslot10 === speciesid) return true;
    }
    if (typeof location.waterslot1 !== "undefined") {
      if (location.waterslot1 === speciesid) return true;
      if (location.waterslot2 === speciesid) return true;
      if (location.waterslot3 === speciesid) return true;
      if (location.waterslot4 === speciesid) return true;
      if (location.waterslot5 === speciesid) return true;
    }
    if (typeof location.rockslot1 !== "undefined") {
      if (location.rockslot1 === speciesid) return true;
      if (location.rockslot2 === speciesid) return true;
      if (location.rockslot3 === speciesid) return true;
      if (location.rockslot4 === speciesid) return true;
      if (location.rockslot5 === speciesid) return true;
    }
  };
...
var BattlePokemonSearch = /** @class */ (function (_super) {
  ...
  BattlePokemonSearch.prototype.getBaseResults = function () {
    ...
    if ((format.endsWith("cap") || format.endsWith("caplc")) && dex.gen < 9) {
      ...
      (_b = this.formatType) === null || _b === void 0
        ? void 0
        : _b.startsWith("bdsp")
    ) {
      ...
      (_c = this.formatType) === null || _c === void 0
        ? void 0
        : _c.startsWith("dlc1")
    ) {
    ...
    if (format === "ubers" || format === "uber")
      ...
      ((_d = this.formatType) === null || _d === void 0
        ? void 0
        : _d.startsWith("bdsp")) ||
      this.formatType === "letsgo" ||
      this.formatType === "stadium"
      ...
      tierSet = __spreadArray(
        __spreadArray(
          __spreadArray(
            __spreadArray([], tierSet.slice(slices.OU, slices.UU), true),
      ...
      tierSet = __spreadArray(
        __spreadArray(
          __spreadArray([], tierSet.slice(slices.DOU, slices.DUU), true),
    ...
    if (dex.gen >= 5) {
      ...
      if (
        (format === "monotype" || format.startsWith("monothreat")) &&
        table.monotypeBans
      ) {
        tierSet = tierSet.filter(function (_a) {
          var type = _a[0],
  ...
  BattlePokemonSearch.prototype.sort = function (
    results,
    sortCol,
    reverseSort,
  ) {
...
var BattleAbilitySearch = /** @class */ (function (_super) {
  ...
  BattleAbilitySearch.prototype.getBaseResults = function () {
    ...
    if (isAAA || format.includes("metronomebattle") || isHackmons) {
      ...
      for (
        var _i = 0,
          _a = abilities.sort().map(function (abil) {
      ...
      abilitySet = __spreadArray(
        __spreadArray(
          __spreadArray([], goodAbilities, true),
          poorAbilities,
          true,
        ),
        badAbilities,
  ...
  BattleAbilitySearch.prototype.sort = function (
    results,
    sortCol,
    reverseSort,
  ) {
...
var BattleItemSearch = /** @class */ (function (_super) {
  ...
  BattleItemSearch.prototype.getBaseResults = function () {
    ...
    for (var _i = 0, results_1 = results; _i < results_1.length; _i++) {
      ...
      if (
        (_a = this.dex.items.get(row[1]).itemUser) === null || _a === void 0
          ? void 0
          : _a.includes(speciesName)
      ) {
...
var BattleLocationSearch = /** @class */ (function (_super) {
  ...
  BattleLocationSearch.prototype.filter = function (row, filters) {
    ...
    for (var _i = 0, filters_4 = filters; _i < filters_4.length; _i++) {
      ...
      switch (filterType) {
        case "pokemon":
          if (!this.isHere(value, location)) return false;
          break;
      }
    }
    return true;
  };
  BattleLocationSearch.prototype.sort = function (
    results,
    sortCol,
    reverseSort,
  ) {
...
var BattleMoveSearch = /** @class */ (function (_super) {
  ...
  BattleMoveSearch.prototype.moveIsNotUseless = function (
    id,
    species,
    moves,
    set,
    ...
    if (
      (_b = moveData.flags) === null || _b === void 0 ? void 0 : _b.recharge
    ) {
      return false;
    }
    if (
      ((_c = moveData.flags) === null || _c === void 0 ? void 0 : _c.slicing) &&
      abilityid === "sharpness"
    ) {
      return true;
    }
  ...
  BattleMoveSearch.prototype.getBaseResults = function () {
        ...
        for (var moveid in learnset) {
          ...
          if (
            ((_c = this.formatType) === null || _c === void 0
              ? void 0
              : _c.startsWith("dlc1")) &&
            ((_d = BattleTeambuilderTable["gen8dlc1"]) === null || _d === void 0
              ? void 0
              : _d.nonstandardMoves.includes(moveid))
          ) {
            continue;
          }
      ...
      for (var id in this.getTable()) {
        ...
        for (var i = dex.gen; i >= species.gen && i >= move.gen; i--) {
          ...
          if (
            ...
            for (
              var _i = 0, _e = baseSpecies.otherFormes;
              _i < _e.length;
              _i++
            ) {
              var formeName = _e[_i];
        ...
        var valid = false;
        for (
          var _f = 0, moveTypes_2 = moveTypes;
          _f < moveTypes_2.length;
          _f++
        ) {
    ...
    for (
      var _h = 0, sketchMoves_2 = sketchMoves;
      _h < sketchMoves_2.length;
      _h++
    ) {
    ...
    return __spreadArray(
      __spreadArray([], usableMoves, true),
      uselessMoves,
      true,
    );
  };
...
var BattleCategorySearch = /** @class */ (function (_super) {
  ...
  BattleCategorySearch.prototype.sort = function (
    results,
    sortCol,
    reverseSort,
  ) {
