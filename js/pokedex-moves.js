...
var PokedexMovePanel = PokedexResultPanel.extend({
  initialize: function (id) {
      ...
      switch (move.isNonstandard) {
        ...
        case "Unobtainable":
          if (move.isMax) {
            ...
            buf +=
              "This move can't be learned normally, it can only be used with a Z-Crystal.";
          } else {
        ...
        case "CAP":
          buf +=
            'This is a made-up move by <a href="http://www.smogon.com/cap/" target="_blank">Smogon CAP</a>.';
          break;
        case "LGPE":
    ...
    buf +=
      ...
      move.pp +
      (move.pp > 1
        ? ' <small class="minor">(max: ' + (8 / 5) * move.pp + ")</small>"
        : "") +
      "</dd>";
    ...
    if (move.isZ) {
      buf +=
        '<p><strong><a href="/tags/zmove" data-target="push">[Z-Move]</a></strong>';
      if (move.isZ !== true) {
        var zItem = Dex.items.get(move.isZ);
        buf +=
          ' requiring <a href="/items/' +
          zItem.id +
          '" data-target="push">' +
          zItem.name +
          "</a>";
      ...
      if (move.isMax !== true) {
        buf +=
          '<p><strong><a href="/tags/gmaxmove" data-target="push">[G-Max Move]</a></strong>';
        var maxUser = Dex.species.get(move.isMax);
        buf +=
          ' used by <a href="/pokemon/' +
          maxUser.id +
        ...
        buf +=
          '<p><strong><a href="/tags/maxmove" data-target="push">[Max Move]</a></strong>';
      }
    }
    ...
    if ("defrost" in move.flags) {
      buf +=
        '<p><a class="subtle" href="/tags/defrost" data-target="push">The user thaws out</a> if it is frozen.</p>';
    }
    if (!("protect" in move.flags) && move.target !== "self") {
      buf +=
        '<p class="movetag"><a href="/tags/bypassprotect" data-target="push">Bypasses Protect</a> <small>(bypasses <a class="subtle" href="/moves/protect" data-target="push">Protect</a>, <a class="subtle" href="/moves/detect" data-target="push">Detect</a>, <a class="subtle" href="/moves/kingsshield" data-target="push">King\'s Shield</a>, and <a class="subtle" href="/moves/spikyshield" data-target="push">Spiky Shield</a>)</small></p>';
    }
    if ("bypasssub" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/bypasssub" data-target="push">Bypasses Substitute</a> <small>(bypasses but does not break a <a class="subtle" href="/moves/substitute" data-target="push">Substitute</a>)</small></p>';
    }
    if (
      !("reflectable" in move.flags) &&
      move.target !== "self" &&
      move.category === "Status"
    ) {
      buf +=
        '<p class="movetag"><a href="/tags/nonreflectable" data-target="push">&#x2713; Nonreflectable</a> <small>(can\'t be bounced by <a class="subtle" href="/moves/magiccoat" data-target="push">Magic Coat</a> or <a class="subtle" href="/abilities/magicbounce" data-target="push">Magic Bounce</a>)</small></p>';
    }
    if (!("mirror" in move.flags) && move.target !== "self") {
      buf +=
        '<p class="movetag"><a href="/tags/nonmirror" data-target="push">&#x2713; Nonmirror</a> <small>(can\'t be copied by <a class="subtle" href="/moves/mirrormove" data-target="push">Mirror Move</a>)</small></p>';
    }
    if (
      !("snatch" in move.flags) &&
      (move.target === "self" ||
        move.target === "allyTeam" ||
        move.target === "adjacentAllyOrSelf")
    ) {
      buf +=
        '<p class="movetag"><a href="/tags/nonsnatchable" data-target="push">&#x2713; Nonsnatchable</a> <small>(can\'t be copied by <a class="subtle" href="/moves/snatch" data-target="push">Snatch</a>)</small></p>';
    }

    if ("contact" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/contact" data-target="push">&#x2713; Contact</a> <small>(affected by many abilities like Iron Barbs and moves like Spiky Shield)</small></p>';
    }
    if ("sound" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/sound" data-target="push">&#x2713; Sound</a> <small>(bypasses <a class="subtle" href="/moves/substitute" data-target="push">Substitute</a>, doesn\'t affect <a class="subtle" href="/abilities/soundproof" data-target="push">Soundproof</a> pokemon)</small></p>';
    }
    if ("powder" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/powder" data-target="push">&#x2713; Powder</a> <small>(doesn\'t affect <a class="subtle" href="/types/grass" data-target="push">Grass</a>-types, <a class="subtle" href="/abilities/overcoat" data-target="push">Overcoat</a> pokemon, and <a class="subtle" href="/items/safetygoggles" data-target="push">Safety Goggles</a> holders)</small></p>';
    }
    if ("punch" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/fist" data-target="push">&#x2713; Fist</a> <small>(boosted by <a class="subtle" href="/abilities/ironfist" data-target="push">Iron Fist</a>)</small></p>';
    }
    if ("pulse" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/pulse" data-target="push">&#x2713; Pulse</a> <small>(boosted by <a class="subtle" href="/abilities/megalauncher" data-target="push">Mega Launcher</a>)</small></p>';
    }
    if ("bite" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/bite" data-target="push">&#x2713; Bite</a> <small>(boosted by <a class="subtle" href="/abilities/strongjaw" data-target="push">Strong Jaw</a>)</small></p>';
    }
    if ("bullet" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/ballistic" data-target="push">&#x2713; Ballistic</a> <small>(doesn\'t affect <a class="subtle" href="/abilities/bulletproof" data-target="push">Bulletproof</a> pokemon)</small></p>';
    }
    if ("slicing" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/slicing" data-target="push">&#x2713; Slicing</a> <small>(boosted by <a class="subtle" href="/abilities/sharpness" data-target="push">Sharpness</a>)</small></p>';
    }
    if ("wind" in move.flags) {
      buf +=
        '<p class="movetag"><a href="/tags/wind" data-target="push">&#x2713; Wind</a> <small>(interacts with <a class="subtle" href="/abilities/windpower" data-target="push">Wind Power</a> and <a class="subtle" href="/abilities/windrider" data-target="push">Wind Rider</a>)</small></p>';
    }

    if (move.target === "allAdjacent") {
      buf +=
        '<p class="movetag"><small>In Doubles, hits all adjacent Pokémon (including allies)</small></p>';
    } else if (move.target === "allAdjacentFoes") {
      buf +=
        '<p class="movetag"><small>In Doubles, hits all adjacent foes</small></p>';
    } else if (move.target === "randomNormal") {
      buf +=
        '<p class="movetag"><small>In Doubles, hits a random foe (you can\'t choose its target)</small></p>';
    } else if (move.target === "adjacentAllyOrSelf") {
      buf +=
        '<p class="movetag"><small>In Doubles, can be used either on the user or an adjacent ally</small></p>';
    }
    ...
    if (
      !move.isMax &&
      (move.zMovePower || move.zMoveEffect || move.zMoveBoost)
    ) {
      buf += "<h3>Z-Move(s)</h3>";
      if (move.zMovePower) {
        buf +=
          '<p><strong><a href="/moves/' +
          toID(zMoveTable[move.type]) +
          '" data-target="push">';
      ...
      if (move.zMoveEffect === "heal") {
        buf +=
          "<p><strong>Z-" +
          move.name +
          "</strong>: fully heals the user, then uses " +
          move.name +
          "</p>";
      ...
      if (id in zMoveVersionTable) {
        ...
        if (zMove.basePower) {
          buf +=
            "" + zMove.basePower + " base power, " + zMove.category + "</p>";
        } else {
          buf += zMove.shortDesc;
        }
        buf += "</p>";
    ...
    if (move.gmaxPower && !move.isZ && !move.isMax) {
      ...
      if (move.type in gmaxMoveTable && move.category !== "Status") {
        for (let i = 0; i < gmaxMoveTable[move.type].length; i++) {
          ...
          buf +=
            '<p>Becomes <strong><a href="/moves/' +
            gmaxMove.id +
            '" data-target="push">' +
            gmaxMove.name +
            "</a></strong> ";
          buf +=
            'if used by <strong><a href="/pokemon/' +
            gmaxMove.isMax +
            'gmax" data-target="push">' +
            gmaxMove.isMax +
            "-Gmax</a></strong>";
    ...
    if (leftPanel && leftPanel.fragment.slice(0, 8) === "pokemon/") {
      ...
      var learnset =
        BattleLearnsets[pokemon.id] && BattleLearnsets[pokemon.id].learnset;
      if (!learnset)
      ...
      while (true) {
        ...
        for (
          var i = 0, len = sources.length, gen = "" + Dex.gen;
          i < len;
          i++
        ) {
          ...
          switch (sourceType) {
            ...
            case "E":
              ...
              for (var breederid in BattleLearnsets) {
                if (
                  !BattleLearnsets[breederid].learnset ||
                  !BattleLearnsets[breederid].learnset[id]
                )
                  continue;
                ...
                if (
                  breederid === pokemon.id ||
                  breederid === template.id ||
                  breederid === pokemon.prevo
                )
                  continue;
                if (
                  eg1 === breeder.eggGroups[0] ||
                  eg1 === breeder.eggGroups[1] ||
                  (eg2 &&
                    (eg2 === breeder.eggGroups[0] ||
                      eg2 === breeder.eggGroups[1]))
                ) {
                  if (hasBreeders) buf += ", ";
                  buf +=
                    '<a href="/pokemon/' +
  ...
  renderRow: function (i, offscreen) {
    ...
    if (!template) {
      ...
      switch (results[i].charAt(0)) {
        case "a": // level-up move
          desc =
            results[i].substr(1, 3) === "001"
              ? "&ndash;"
              : results[i].substr(1, 3) === "000"
                ? "Evo."
                : "<small>L</small>" +
                  (parseInt(results[i].substr(1, 3), 10) || "?");
          break;
        case "b": // tm/hm
          desc =
            '<img src="//' +
