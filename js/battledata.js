...
var Dex = new ((function () {
  function _class3() {
    ...
    this.locations = {
      get: function (nameOrLocation) {
        if (nameOrLocation && typeof nameOrLocation !== "string") {
          return nameOrLocation;
        }
        var name = nameOrLocation || "";
        var id = toID(nameOrLocation);
        if (window.BattleAliases && id in BattleAliases) {
          name = BattleAliases[id];
          id = toID(name);
        }
        ...
        if (data && typeof data.exists === "boolean") return data;
        if (!data) data = { exists: false };
        var loc = new Move(id, name, data);
        window.BattleLocationdex[id] = loc;
        return loc;
      },
    };
    this.items = {
  ...
  _proto2.getSpriteData = function getSpriteData(pokemon, isFront) {
    var _window$Config2, _window$Config2$serve;
    var options =
    ...
    if (
      Dex.prefs("afd") !== false &&
      (((_window$Config2 = window.Config) != null &&
        (_window$Config2$serve = _window$Config2.server) != null &&
        _window$Config2$serve.afd) ||
        Dex.prefs("afd") ||
        options.afd)
    ) {
      dir = "afd" + dir;
  ...
  _proto2.getPokemonIcon = function getPokemonIcon(pokemon, facingLeft) {
    ...
    return (
      "background:transparent url(" +
      Dex.resourcePrefix +
      "sprites/pokemonicons-sheet.png?v16) no-repeat scroll -" +
      left +
      "px -" +
      top +
      "px" +
  ...
  _proto2.getTeambuilderSpriteData = function getTeambuilderSpriteData(
    ...
    var _window$Config3, _window$Config3$serve;
    var gen =
    ...
    if (
      ((_window$Config3 = window.Config) != null &&
        (_window$Config3$serve = _window$Config3.server) != null &&
        _window$Config3$serve.afd) ||
      Dex.prefs("afd")
    ) {
      return {
        spriteid: spriteid,
  ...
  _proto2.getItemIcon = function getItemIcon(item) {
    ...
    return (
      "background:transparent url(" +
      Dex.resourcePrefix +
      "sprites/itemicons-sheet.png?v1) no-repeat scroll -" +
      left +
      "px -" +
      top +
      "px"
...
var Teams = new ((function () {
  ...
  _proto4.unpack = function unpack(buf) {
    if (!buf) return [];
  ...
  _proto4["export"] = function _export(team, gen) {
    var hidestats =
    ...
    var text = "";
    for (var _i10 = 0, _team2 = team; _i10 < _team2.length; _i10++) {
      var curSet = _team2[_i10];
      ...
      if (gen === 9) {
        ...
        text +=
          "Tera Type: " +
          (species.forceTeraType || curSet.teraType || species.types[0]) +
          "  \n";
      }
      if (!hidestats) {
        var first = true;
        ...
        if (curSet.ivs) {
          ...
          var hpType = "";
          for (
            var _i12 = 0, _curSet$moves2 = curSet.moves;
            _i12 < _curSet$moves2.length;
            _i12++
          ) {
            var move = _curSet$moves2[_i12];
            if (
              ...
              for (stat in BattleStatNames) {
                var _Dex$types$get$HPivs;
                if (
                  (curSet.ivs[stat] === undefined ? 31 : curSet.ivs[stat]) !==
                  (((_Dex$types$get$HPivs = Dex.types.get(hpType).HPivs) == null
                    ? void 0
                    : _Dex$types$get$HPivs[stat]) || 31)
                ) {
                  defaultIvs = false;
                  break;
                }
          ...
          if (!defaultIvs) {
            ...
            for (_stat2 in BattleStatNames) {
              if (
                typeof curSet.ivs[_stat2] === "undefined" ||
                isNaN(curSet.ivs[_stat2]) ||
                curSet.ivs[_stat2] === 31
              )
                continue;
              if (first) {
                text += "IVs: ";
      ...
      if (curSet.moves) {
        for (
          var _i14 = 0, _curSet$moves4 = curSet.moves;
          _i14 < _curSet$moves4.length;
          _i14++
        ) {
          var _move = _curSet$moves4[_i14];
...
var Species = function Species(id, name, data) {
  ...
  this.evoMap = data.evoMap || "";
  this.evoSpecies = data.evoSpecies || "";
 ...
 */ var BattleLog = (function () {
  ...
  _proto.add = function add(args, kwArgs, preempt) {
    ...
    var battle =
      (_this$scene = this.scene) == null ? void 0 : _this$scene.battle;
    ...
    switch (args[0]) {
      ...
      case "c:":
        ...
        if (battle != null && battle.ignoreSpects && " +".includes(rank))
          return;
        ...
        var isHighlighted =
          (_window$app2 = window.app) == null
            ...
            : (_window$app2$rooms = _window$app2.rooms) == null
              ? void 0
              : _window$app2$rooms[battle.roomid].getHighlight(message);
      ...
      case "l": {
        ...
        if (battle != null && battle.ignoreSpects && " +".includes(user.group))
          return;
      ...
      case "showteam": {
        ...
        var exportedTeam = team
              ...
              buf = buf.replace(
                ...
                BattleLog.sanitizeHTML(
                  '<span class="picon" style="' +
                    Dex.getPokemonIcon(set.species) +
                    '"></span><br />' +
                    set.name,
                ),
              );
          ...
          .join("");
        divHTML =
          '<div class="infobox"><details><summary>Open Team Sheet for ' +
          side.name +
          "</summary>" +
          exportedTeam +
          "</details></div>";
      ...
      if (tagName === "a") {
        ...
        return {
          ...
          attribs: [
            ...
            "select formatselect",
            "value",
            getAttrib("format") || getAttrib("value") || "",
            "name",
            getAttrib("name") || "",
          ],
        };
        ...
        events: {
          onStateChange: function (event) {
            if (event.data === window.YT.PlayerState.PLAYING) {
              for (
                var _i22 = 0, _BattleLog$players2 = BattleLog.players;
  ...
  BattleLog.createReplayFile = function createReplayFile(room) {
    ...
    if (replayid) {
      ...
      if (
        ((_window$Config = window.Config) == null
          ? void 0
          : _window$Config.server.id) !== "showdown"
      ) {
        var _window$Config2;
        if (
          !(
            (_window$Config2 = window.Config) != null &&
            _window$Config2.server.registered
          )
        ) {
  ...
  BattleLog.createReplayFileHref = function createReplayFileHref(room) {
    ...
    return (
      ...
      encodeURIComponent(btoa(unescape(encodeURIComponent(replayFile))))
    );
  };
  return BattleLog;
})();
...
exports.BattleText = {
  default: {
    ...
    party: "your ally PokÃ©mon",
    opposingParty: "the opposing PokÃ©mon",
    turn: "== Turn [NUMBER] ==",
    ...
    hitCount: "  The PokÃ©mon was hit [NUMBER] times!",
    hitCountSingular: "  The PokÃ©mon was hit 1 time!",
  },
  ...
  deltastream: {
    ...
    start: "  Mysterious strong winds are protecting Flying-type PokÃ©mon!",
  ...
  magicroom: {
    start:
      "  It created a bizarre area in which PokÃ©mon's held items lose their effects!",
  ...
  gmaxcannonade: {
    ...
    damage: "  [POKEMON] is hurt by G-Max Cannonadeâ€™s vortex!",
  },
  ...
  gmaxvinelash: {
    ...
    damage: "  [POKEMON] is hurt by G-Max Vine Lashâ€™s ferocious beating!",
  },
  gmaxvolcalith: {
  ...
  gmaxwildfire: {
    ...
    damage: "  [POKEMON] is burning up within G-Max Wildfireâ€™s flames!",
  },
  grasspledge: {
    activate: "#waterpledge",
  ...
  perishsong: {
    start: "  All PokÃ©mon that heard the song will faint in three turns!",
  ...
  powder: {
    ...
    activate:
      "  When the flame touched the powder on the PokÃ©mon, it exploded!",
  },
  ...
  aurabreak: { start: "  [POKEMON] reversed all other PokÃ©mon's auras!" },
  baddreams: {
    descGen6:
  ...
  beadsofruin: {
    start:
      "  [POKEMON]'s Beads of Ruin weakened the Sp. Def of all surrounding PokÃ©mon!",
  },
  blaze: {
    descGen4:
  ...
  heatproof: {
    descGen8:
      "The power of Fire-type attacks against this Pokemon is halved. This Pokemon takes half of the usual burn damage, rounded down.",
    shortDescGen8:
  ...
  illuminate: { shortDescGen8: "No competitive use." },
  ...
  lingeringaroma: {
    descGen8:
      "Pokemon making contact with this Pokemon have their Ability changed to Lingering Aroma. Does not affect Pokemon with the As One, Battle Bond, Comatose, Disguise, Gulp Missile, Ice Face, Lingering Aroma, Multitype, Power Construct, RKS System, Schooling, Shields Down, Stance Change, or Zen Mode Abilities.",
  ...
  neutralizinggas: {
    descGen8:
      "While this Pokemon is active, Abilities have no effect. This Ability activates before hazards and other Abilities take effect. Does not affect the As One, Battle Bond, Comatose, Disguise, Gulp Missile, Ice Face, Multitype, Neutralizing Gas, Power Construct, RKS System, Schooling, Shields Down, Stance Change, or Zen Mode Abilities.",
  ...
  perishbody: { start: "  Both PokÃ©mon will faint in three turns!" },
  pickup: {
  ...
  swordofruin: {
    start:
      "  [POKEMON]'s Sword of Ruin weakened the Defense of all surrounding PokÃ©mon!",
  },
  symbiosis: {
    descGen7:
  ...
  tabletsofruin: {
    start:
      "  [POKEMON]'s Tablets of Ruin weakened the Attack of all surrounding PokÃ©mon!",
  },
  technician: {
    descGen4:
  ...
  telepathy: {
    block: "  [POKEMON] can't be hit by attacks from its ally PokÃ©mon!",
  },
  terashell: {
    activate:
      "  [POKEMON] made its shell gleam! It's distorting type matchups!",
  },
  ...
  vesselofruin: {
    start:
      "  [POKEMON]'s Vessel of Ruin weakened the Sp. Atk of all surrounding PokÃ©mon!",
  },
  voltabsorb: {
    descGen3:
  ...
  wanderingspirit: {
    descGen8:
      "Pokemon making contact with this Pokemon have their Ability swapped with this one. Does not affect Pokemon with the Abilities As One, Battle Bond, Comatose, Disguise, Gulp Missile, Hunger Switch, Ice Face, Illusion, Multitype, Neutralizing Gas, Power Construct, RKS System, Schooling, Shields Down, Stance Change, Wonder Guard, or Zen Mode.",
    activate: "#skillswap",
  },
  weakarmor: {
    descGen6:
  ...
  stick: {
    descGen2:
      "If held by a Farfetchâ€™d, its critical hit ratio is always at stage 2. (25% crit rate)",
  },
  thunderstone: {
    descGen7:
  ...
  BattleTextParser.upgradeArgs = function upgradeArgs(_ref) {
    ...
    switch (args[0]) {
      ...
      case "-heal": {
        ...
        if (
          ["dryskin", "eartheater", "voltabsorb", "waterabsorb"].includes(_id2)
        )
          kwArgs.of = "";
        break;
      }
  ...
  _proto.template = function template(type) {
    ...
    for (var _i4 = 0; _i4 < namespaces.length; _i4++) {
      ...
      if (BattleText[_id3] && type in BattleText[_id3]) {
        if (BattleText[_id3][type].charAt(1) === ".")
          type = BattleText[_id3][type].slice(2);
        if (BattleText[_id3][type].charAt(0) === "#")
          _id3 = BattleText[_id3][type].slice(1);
  ...
  _proto.parseArgsInner = function parseArgsInner(args, kwArgs) {
    ...
    switch (cmd) {
      ...
      case "-start": {
        ...
        if (
          _id9.startsWith("protosynthesis") ||
          _id9.startsWith("quarkdrive")
        ) {
          var stat = _id9.slice(-3);
          var _template14 = this.template(
            "start",
            _id9.slice(0, _id9.length - 3),
          );
          return (
            _line4 +
            _template14
        ...
        if (_id9 === "mist" && this.gen <= 2)
          templateId = "startGen" + this.gen;
        if (_id9 === "reflect" || _id9 === "lightscreen")
      ...
      case "-ability": {
        ...
        if (_id11 === "anticipation" || _id11 === "sturdy")
      ...
      case "-item": {
        ...
        if (
          ["thief", "covet", "bestow", "magician", "pickpocket"].includes(_id12)
        ) {
      ...
      case "-activate": {
        ...
        if (
          (_id15 === "mummy" || _id15 === "lingeringaroma") &&
          kwArgs.ability
        ) {
          _line15 += this.ability(kwArgs.ability, _target2);
          _line15 += this.ability(
            _id15 === "mummy" ? "Mummy" : "Lingering Aroma",
            _target2,
          );
        ...
        if (
          (_id15 === "protosynthesis" || _id15 === "quarkdrive") &&
          kwArgs.fromitem
        ) {
      ...
      case "-unboost": {
        ...
        return (
          _line18 +
          _template55
            .replace(/\[POKEMON\]/g, this.pokemon(_pokemon23))
            .replace("[STAT]", BattleTextParser.stat(_stat2))
        );
      }
